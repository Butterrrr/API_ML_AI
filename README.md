...
| 2 |  改装车型  | 喜欢改装车型的用户可以用这款app识别改装过的车辆 | 重要 | 改装的可以骗过人工智能也可以是用户互动的玩法  |

## • 目标用户
• 打算购买车辆的用户可以用该app认识更多的车辆，了解关于车辆的型号

• 喜欢改装车辆的用户可以用该app识别自己改装的车辆，试探人工智能的概率性

• 倒车不小心刮到别人车的用户可以用该app识别车型，搜索得出车辆价格后决定是否逃逸
...
## • MVP
• 最小可行性的产品是一款可以识别车型的app，识别车型是最核心的价值，也是这款产品最核心的功能价值
